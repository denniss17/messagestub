        ...
        try {
            switch (message.getType()) {
                case "IJW301":
                    ...
                    message.getMeta().setGemeenteCode(ijw301Bericht.getHeader().getAfzender());
                ...
                case "IJW302":
                    ...
                    message.getMeta().setGemeenteCode(ijw302Bericht.getHeader().getAfzender());
                ...
                case "IJW303":
                    ...
                    message.getMeta().setGemeenteCode(ijw303Bericht.getHeader().getGemeente());
                    break;
                case "IJW305":
                    ...
                    message.getMeta().setGemeenteCode(ijw305Bericht.getHeader().getAfzender());
                ...
                case "IJW306":
                    ...
                    message.getMeta().setGemeenteCode(ijw306Bericht.getHeader().getAfzender());
                ...
                case "IJW307":
                    ...
                    message.getMeta().setGemeenteCode(ijw307Bericht.getHeader().getAfzender());
                ...
                case "IJW308":
                    ...
                    message.getMeta().setGemeenteCode(ijw308Bericht.getHeader().getAfzender());
                ...
                case "IJW315":
                    ...
                    message.getMeta().setAgbCode(ijw315Bericht.getHeader().getAfzender());
                    message.getMeta().setGemeenteCode(ijw315Bericht.getHeader().getOntvanger());
                ...
                case "IJW316":
                    ...
                    message.getMeta().setAgbCode(ijw316Bericht.getHeader().getAfzender());
                    message.getMeta().setGemeenteCode(ijw316Bericht.getHeader().getOntvanger());
